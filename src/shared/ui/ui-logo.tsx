...
export function UiLogo({className}:{className?: string}) {
  ...
  return (
    <UiLink className={clsx(className)} href={isLending ? 'javascript:void(0)' : '/'}>
      <svg 
        className={clsx(className,"h-24 w-36 text-rose-600", isLending ? "cursor-default" : "hover:text-red-500")}
